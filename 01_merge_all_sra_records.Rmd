...
head(sort(table(sraPre[!is.na(sraPre$Sample.Name),]$Sample.Name), decreasing=T), n = 20) # Keep
...
sraPreOld <- sraPre[,c('SRA.Study','Center.Name','BioSample','Organism','LibrarySource','Cell_type','Tissue','Cell_line','disease','ETHNICITY','disease_state','Diagnosis','tissue_type','clinical_information','RACE','Site','health_state','Population','tissue_source','geo_loc_name_country','geo_loc_name_country_continent','DONOR_HEALTH_STATUS','DONOR_ETHNICITY','geo_loc_name','reported_race','source_tissue',"ReleaseDate","create_date","ancestry","donor_id", "Sample_type", "Sample.Name", "source_name", "source_material_cell_type", "source_material", "tissue.cell_type_source", "tissue_source")]

# There's a couple of rows with a tab in them, which confuses the fread command later, so we should strip that:
sraPreOld$Sample.Name <- gsub("\t293T", "293T", sraPreOld$Sample.Name)
...
sraPreNew <- sraPre[,c('SRA.Study','Center.Name','BioSample','Organism','LibrarySource','Cell_type','Tissue','Cell_Line','disease','ETHNICITY','disease_state','Diagnosis','tissue_type','clinical_information','RACE','Site','health_state','Population','tissue_source','geo_loc_name_country','geo_loc_name_country_continent','geo_loc_name','reported_race','source_tissue',"ReleaseDate","create_date","ancestry","race.ethnicity","primary_race",'geographical_location',"donor_id", "Sample.Name", "source_name", "source_materal_id", "tissue_source", "SAMPLE_TYPE", "sample_origin", "tissue.cell_type_source", "source_organ", "Sampling_site")]
