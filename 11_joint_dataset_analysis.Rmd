...
We will finally analyse this data properly, and bring all datasets together...  
...
allRaziFinal$pred_pop <- factor(allRaziFinal$pred_pop, levels = c("AFR", "EUR", "SAS", "EAS", "AMR", "")) 

# NA is grey50
scale_fill_kasper <- function(...){
    ggplot2:::manual_scale('fill',  
        values = setNames(c('#9C8DC3', '#DB6968', '#60BC55', '#4D97CD', '#F8984E', 'grey50'), levels(allRaziFinal$pred_pop)), 
    )
}
