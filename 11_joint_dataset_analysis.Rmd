...
allCountry <- rbind.fill(sraCountry, dbGapCountry)
...
How overrepresented are these numbers? We begin by grabbing the UN population data and doing some more mergers:
