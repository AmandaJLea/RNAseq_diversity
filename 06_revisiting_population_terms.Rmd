...
2. Alternative 1: **Manual review** Leave things as they were with the original reclassification that we used, which does make some assumptions - caucasian is always racial, and white gets moved around a bit. This was our initial approach and was explored in more depth in `03_clean_up_ancestry_terms`, see that script for a more detailed breakdown. *Our full recoding under this schema is presented in Table S6 in the paper under the "alternative" heading, and coded in all downstream analyses as `finalRace` and `finalGeography`.*
