...
allSRAFinal <- readRDS("20250517_allSRAAncestry.rds")
...
saveRDS(allSRAFinal, "20250517_allSRAAncestryTissues.rds")
```
...
for (i in 1:nrow(diseaseTerms)){
  tryCatch({
  allSRAFinal[allSRAFinal[,as.character(diseaseTerms$coded.as[i])] %in% diseaseTerms$Term[i],]$finalDisease <- diseaseTerms$grouping[i]}, error = function(e) {
...
saveRDS(allSRAFinal, "20250517_allSRAAncestryTissuesDisease.rds")
```
