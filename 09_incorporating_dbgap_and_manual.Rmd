...
Files from Amanda and Grace are in different formats than the SRA one, so they need to be processed so we can do some joint plotting for figures 1 and 2. Nothing has changed in terms of how this is processed but I'm updating file names to be consistent. 
