...
ggsave("all_dbs_sample_properties.pdf", width = 8, height = 4)
ggsave("all_dbs_sample_properties.png", width = 8, height = 4)
```
...
geoPlot + litRevGeoPlot + dbgapPlot + racePlot + litRevRacePlot +
    ...
    plot_annotation(tag_levels = 'a')
ggsave("all_dbs_descriptors.pdf", width = 8, height = 4)
ggsave("all_dbs_descriptors.png", width = 8, height = 4)
